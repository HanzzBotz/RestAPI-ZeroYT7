...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO HANZZ BOTZ API!') // boleh diubah
}

var creatorList = ['Hanzz-kun']; // Nama Lu Ngab
var creator = creatorList[Math.floor(Math.random() * creatorList.length)]; // Ini jan diubah
var key = 'HanzzGanz' // Apikey Lu Ngab
...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: `Apikey tidak ditemukan! Silahkan kontak Owner untuk dapatkan Apikey wa.me/6281212083267`
    },
    invalidLink: {
        status: false,
        creator: `${creator}`,
...
// Api Features :
        ...
        var randomTextNumber = random+randomlagi+'---------kuhong-api-storage'+'HanzzGanz';
